...
// $this->Ln(8);
// $this->setFont('Arial','',14,'C');
// $this->Cell(10,0,'PERAWATAN NVR / DVR');
...
$this->CELL(62,5,'ITEM YANG DI CEK ',1,0,'C');
...
$this->setY(45);
$this->setX(184);
$this->CELL(19,9,'NVR / DVR','B',0,'C');
$this->CELL(23,5,'Kamera','L',0,'C');
$this->CELL(20,9,'Hardisk','LB',0,'C');

$this->setY(49);
$this->setX(203);
$this->CELL(23,5,'dari Live View','LB',0,'C');


$this->setY(42);
$this->setX(184);
$this->CELL(19,6,'Kondisi','T',0,'C');
$this->CELL(23,5,'Kondisi Rekaman','LR',0,'C');
$this->CELL(20,6,'Kondisi Failure','LR',0,'C');
