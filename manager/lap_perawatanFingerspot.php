<?php
require('kop_perawatanFingerspot.php');
...
$pdf->SetWidths(array(7,25,25,25,37,50,18,22 ,23,15,15,20));
...
//$sql=mysql_query("Select * from peripheral where bulan like'%".$bulan."%' and divisi like '%".$pdivisi."%' and tipe = 'fingerspot' order by nomor ");

//$sql=mysql_query("SELECT * FROM peripheral WHERE (bulan LIKE '%".$bulan."%' OR '".$bulan."' = '') AND (divisi LIKE '%".$pdivisi."%' OR '".$pdivisi."' = '') AND tipe = 'fingerspot' ORDER BY nomor;");
