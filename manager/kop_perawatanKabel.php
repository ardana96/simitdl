...
// $this->Ln(8);
// $this->setFont('Arial','',14,'C');
// $this->Cell(10,0,'PERAWATAN KABEL JARINGAN');
...
$this->Cell(10,0,'Kabel Jaringan');
$this->Ln(6);

$this->setFont('Arial','',8);
$this->setFillColor(222,222,222);

$this->CELL(7,11,'NO',1,0,'C');
$this->CELL(25,11,'Lokasi',1,0,'C');
$this->CELL(25,5,'Tgl Perawatan','T',0,'C');
$this->CELL(25,5,'Tgl','LT',0,'C');
...
$this->setY(42);
$this->setX(42);
$this->CELL(25,6,'Terjadwal','B',0,'C');
$this->CELL(25,6,'Realisai','LB',0,'C');
...
$this->CELL(30,6,'Jaringan','B',0,'C');
$this->CELL(15,6,'Petugas',1,0,'C');
$this->CELL(15,6,'User',1,1,'C');
