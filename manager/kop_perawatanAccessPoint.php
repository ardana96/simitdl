...
// $this->Ln(8);
// $this->setFont('Arial','',14,'C');
// $this->Cell(10,0,'PERAWATAN ACCESS POINT');
...
$this->CELL(60,5,'ITEM YANG DI CEK ',1,0,'C');
...
$this->setY(45);
$this->setX(184);
$this->CELL(19,9,'Access Point','B',0,'C');
$this->CELL(20,9,'Indikator','LB',0,'C');
$this->CELL(21,9,'dan SSID','LB',0,'C');
...
$this->CELL(21,6,'Kondisi Koneksi','LR',0,'C');
