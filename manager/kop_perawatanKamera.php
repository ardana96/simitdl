...
// $this->Ln(8);
// $this->setFont('Arial','',14,'C');
// $this->Cell(10,0,'PERAWATAN KAMERA');
...
$this->CELL(67,5,'ITEM YANG DI CEK ',1,0,'C');
...
$this->setY(45);
$this->setX(179);
$this->CELL(16,9,'Fisik','B',0,'C');
$this->CELL(23,9,'Kamera','L',0,'C');
$this->CELL(28,5,'Dilihat dari Monitor/','L',0,'C');

$this->setY(49);
$this->setX(218);
$this->CELL(28,5,'Online NVR/DVR','LB',0,'C');


$this->setY(42);
$this->setX(179);
$this->CELL(16,6,'Kondisi','T',0,'C');
$this->CELL(23,6,'Kondisi Kejelasan','LR',0,'C');
$this->CELL(28,5,'Kondisi View Kamera','LR',0,'C');
