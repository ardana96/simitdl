<?php
require('kop_perawatanKabel.php');
...
$pdf->SetWidths(array(7,25,25,25,37,55,30,15,15,15));
...
//$sql=mysql_query("Select * from peripheral where (bulan LIKE '%".$bulan."%' OR '".$bulan."' = '') AND (divisi LIKE '%".$pdivisi."%' OR '".$pdivisi."' = '') and tipe = 'kabel jaringan'  order by nomor ");
...
WHERE LOWER(a.tipe) = 'kabel jaringan' 
AND
