...
// $this->Ln(8);
// $this->setFont('Arial','',14,'C');
// $this->Cell(10,0,'PERAWATAN FINGERSPOT ');
...
$this->CELL(63,5,'ITEM YANG DI CEK ',1,0,'C');
$this->CELL(30,5,'PARAF',1,0,'C');
$this->CELL(20,17,'KET',1,1,'C');
$this->setY(45);
$this->setX(42);
...
$this->setY(45);
$this->setX(179);
$this->CELL(18,9,'Aset','R',0,'C');
$this->CELL(22,9,'Alat Fingerspot','B',0,'C');
$this->CELL(23,9,'Sensor Sidik Jari','LB',0,'C');



$this->setY(42);
$this->setX(179);
$this->CELL(18,6,'Kesesuaian ','R',0,'C');
$this->CELL(22,6,'Kondisi Fisik ','T',0,'C');
$this->CELL(23,6,'Kondisi Fungsi','LR',0,'C');
