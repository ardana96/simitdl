...
http.open('GET', 'aplikasi/filterscaner.php?nomor=' + encodeURIComponent(nomor) , true);
            ...
            <div class="inner">
                        ...
                        <div class="panel-body">
                            <div class="table-responsive" style='overflow: scroll;'>
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <tbody>
                                       <?$sql = mysql_query("SELECT * FROM scaner");
				...
				?>
                                ...
                                Edit 
											  ...
											  <td class="center"><form action="aplikasi/deletescaner.php" method="post" >
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            ...
                                            <h4 class="modal-title" id="H4"> Tambah Scanner</h4>
                                        </div>
                                        <div class="modal-body">
                                       <form action="aplikasi/simpanscanner.php" method="post"  enctype="multipart/form-data" name="postform2">
                        ...
                        <div class="modal fade" id="newReggg" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                                            <h4 class="modal-title" id="H4"> Edit Scanner</h4>
                                        </div>
                                        <div class="modal-body">
                                       <form action="aplikasi/updatescanner.php" method="post"  enctype="multipart/form-data" name="postform2">
                                        <div class="form-group">
										...
										<div class="form-group">
											Keterangan                                  
                                            <input  placeholder="Keteranan" class="form-control" type="text" name="keterangan" id="keterangan" >
